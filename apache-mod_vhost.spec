...
install -d %{buildroot}%{_localstatedir}/apache-mod_vhost_sqlite3
install -d %{buildroot}%{_localstatedir}/apache-mod_vhost_pgsql
install -d %{buildroot}%{_localstatedir}/apache-mod_vhost_mysql
install -d %{buildroot}%{_localstatedir}/apache-mod_vhost_ldap
...
%attr(0755,apache,apache) %dir %{_localstatedir}/apache-mod_vhost_ldap
...
%attr(0755,apache,apache) %dir %{_localstatedir}/apache-mod_vhost_mysql
...
%attr(0755,apache,apache) %dir %{_localstatedir}/apache-mod_vhost_pgsql
